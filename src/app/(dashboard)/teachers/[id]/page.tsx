      ...
      <div className=" w-full xl:w-1/3 space-y-4">
        <div className=" bg-white p-4 rounded-md">
          ...
          <div className=" mt-4 gap-4 flex flex-wrap text-xs text-gray-500">
            <Link href={"/"} className=" bg-purple px-4 py-2 rounded-sm">
              Teacher&apos;s Classes
            </Link>
            <Link href={"/"} className=" bg-sky px-4 py-2 rounded-sm">
              Teacher&apos;s Students
            </Link>
            <Link href={"/"} className=" bg-skyLight px-4 py-2 rounded-sm">
              Teacher&apos;s Lessons
            </Link>
            <Link href={"/"} className=" bg-yellow px-4 py-2 rounded-sm">
              Teacher&apos;s Exams
            </Link>
            <Link href={"/"} className=" bg-pink-200 px-4 py-2 rounded-sm">
